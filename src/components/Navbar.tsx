...
import { Car, Menu, X, User, CalendarDays, LogIn, Briefcase, LogOut } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  // Masquer la navbar client classique si on est dans le workspace
  const isWorkspace = location.pathname.startsWith('/workspace');
  if (isWorkspace) return null; // Le layout du workspace gère sa propre nav
